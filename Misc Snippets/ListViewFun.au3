...
Func Example()
	...
	msgbox(0, "Item 2", $idLVi_Item2)
	msgbox(0, "Item 3", $idLVi_Item3)
...
;~     GUICtrlSetData($idLVi_Item3, "||COL33")
    ...
    While 1
        Switch GUIGetMsg()
            ...
            Case $idButton
;~                 MsgBox($MB_SYSTEMMODAL, "listview item", (GUICtrlRead($idListview)))
				MsgBox($MB_SYSTEMMODAL, "listview item", GUICtrlRead(GUICtrlRead($idListview)))

            Case $idListview
                MsgBox($MB_SYSTEMMODAL, "listview", "clicked=" & GUICtrlGetState($idListview))
